---
layout: post
title: "Optimal Transport: Wasserstein distances"
categories: blog
...
In this blog post I will gloss over how OT problems are formulated, and introduce a simple, efficient algorithm that is able to solve quite a few problems and can have quite a few extensions.
...
The optimal transport plan is then recovered from $$ \gamma^\star_{i,j} = u_i K_{i,j}v_j $$, or $$ \gamma = K(u \otimes v) $$.
